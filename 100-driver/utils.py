...
#Traditional setting for Cam1,2,3,4; if other settings are required, just add it in another elif         
    if dataset == 'pic-day-cam1':
        trainloader = '../Datasets/100-driver/Day/Cam1'
        trainloadertxt = '../Datasets/100-driver/data-splits/data-splits/Traditional-setting/Day/Cam1/D1_train.txt'
        valloader = '../Datasets/100-driver/Day/Cam1'
        valloadertxt = '../Datasets/100-driver/data-splits/data-splits/Traditional-setting/Day/Cam1/D1_val.txt'
    elif dataset == 'pic-day-cam2':
        trainloader = '../Datasets/100-driver/Day/Cam2'
        trainloadertxt = '../Datasets/100-driver/data-splits/data-splits/Traditional-setting/Day/Cam2/D2_train.txt'
        valloader = '../Datasets/100-driver/Day/Cam2'
        valloadertxt = '../Datasets/100-driver/data-splits/data-splits/Traditional-setting/Day/Cam2/D2_val.txt'
    elif dataset == 'pic-day-cam3':
        trainloader = '../Datasets/100-driver/Day/Cam3'
        trainloadertxt = '../Datasets/100-driver/data-splits/data-splits/Traditional-setting/Day/Cam3/D3_train.txt'
        valloader = '../Datasets/100-driver/Day/Cam3'
        valloadertxt = '../Datasets/100-driver/data-splits/data-splits/Traditional-setting/Day/Cam3/D3_val.txt'
    elif dataset == 'pic-day-cam4':
        trainloader = '../Datasets/100-driver/Day/Cam4'
        trainloadertxt = '../Datasets/100-driver/data-splits/data-splits/Traditional-setting/Day/Cam4/D4_train.txt'
        valloader = '../Datasets/100-driver/Day/Cam4'
        valloadertxt = '../Datasets/100-driver/data-splits/data-splits/Traditional-setting/Day/Cam4/D4_val.txt'
    else:
...
#Traditional setting for Cam1,2,3,4; if other settings are required, just add it in another elif         
    if dataset == 'pic-day-cam1':
        testloader = '../Datasets/100-driver/Day/Cam1'
        testloadertxt = '../Datasets/100-driver/data-splits/data-splits/Traditional-setting/Day/Cam1/D1_test.txt'
    elif dataset == 'pic-day-cam2':
        testloader = '../Datasets/100-driver/Day/Cam2'
        testloadertxt = '../Datasets/100-driver/data-splits/data-splits/Traditional-setting/Day/Cam2/D2_test.txt'
    elif dataset == 'pic-day-cam3':
        testloader = '../Datasets/100-driver/Day/Cam3'
        testloadertxt = '../Datasets/100-driver/data-splits/data-splits/Traditional-setting/Day/Cam3/D3_test.txt'
    elif dataset == 'pic-day-cam4':
        testloader = '../Datasets/100-driver/Day/Cam4'
        testloadertxt = '../Datasets/100-driver/data-splits/data-splits/Traditional-setting/Day/Cam4/D4_test.txt'
    else:
        print('the dataset is not available ')
